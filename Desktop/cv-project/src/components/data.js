...
export const CVData = {
    personalData: {
      name: 'Jola Morountodun',
      title: 'Dance Instructor',
      image: 'https://bulma.io/images/placeholders/128x128.png',
      contacts: [
        { type: 'email', value: 'jola@example.com' },
        { type: 'phone', value: '+00 (123) 456 78 90' },
        { type: 'location', value: 'Nigeria' },
    ...
    sections: [
        ...
        items: [
          {
            ...
            description: 'I\'m working as a lead dancer yeeeey!',
            companyWebSite: 'http://somecompanyexample.com',
            companyMeta: '',
            datesBetween: '2017.10 - Present',
            descriptionTags: ['Salsa', 'Ballet']
          },
          {
            title: 'Dance Instructor',
            company: 'Some Company Example INC',
            description: 'I\'m teaching dance to aspiring dancers',
            companyWebSite: 'http://somecompanyexample.com',
          ...
          {
            title: 'Intern',
            company: 'Some Dance Example INC',
      ...
      },
      {
        ...
        icon: 'rocket',
        items: ['Salsa', 'Ballet', 'Cha-Cha', 'African Dance', 'HipHop', 'Waltz']
      },
      {
        type: 'tag-list',
